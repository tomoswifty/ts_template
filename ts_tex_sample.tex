...
%
% タイトルと著者名
\title{LaTeX文書（サンプル）} % 和文タイトル
\name{杉本智暉　中山ホールディングス} % 著者名
% \etitle{Instruction for SICE SI2021 Annual Conference Manuscript} % 英文タイトル
% \ename{○Taro KEISOKU (SICE), and Hanako SEIGYO (SICE)}	%著者名（英）
%
% アブストラクト
\abst{
This manuscript describes a method for preparing a manuscript for the annual conference of the SICE SI division in 2021. 
}
% タイトルの出力
\maketitle
%
